...
export interface ReadLogicStampDocsOutput {
  ...
  canonicalDocs: {
    ...
    // Primary: landing page (logicstamp.dev/docs/logicstamp-context) - best UX
    // Fallback: CLI repo GitHub docs - always available, versioned
    landingPage: string; // Primary: logicstamp.dev/docs/logicstamp-context
...
export async function readLogicStampDocs(): Promise<ReadLogicStampDocsOutput> {
  try {
    ...
    // This is a frozen snapshot for LLMs - full docs live at logicstamp.dev/docs/logicstamp-context
    ...
    return {
      ...
      canonicalDocs: {
        ...
        landingPage: 'https://logicstamp.dev/docs/logicstamp-context',
        ...
        context: {
          primary: 'https://logicstamp.dev/docs/logicstamp-context/cli/context',
          fallback: 'https://github.com/LogicStamp/logicstamp-context/blob/main/docs/cli/context.md',
        },
        compareModes: {
          primary: 'https://logicstamp.dev/docs/logicstamp-context/cli/compare-modes',
